  ...
  return (
    <section className="py-16 bg-gray-50" aria-label="Maintenance & Care Plans">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="font-calsans text-2xl md:text-3xl font-bold text-center mb-8 text-[color:var(--color-charcoal)]">
        ...
        <div className="text-center text-lg font-semibold text-[color:var(--color-charcoal)]">
          From{" "}
          <span className="text-[color:var(--color-charcoal)]">€79/mo</span> —
